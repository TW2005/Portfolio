...
module instruction_memory #(
    // Parameterized init file used by $readmemh; Quartus requires a literal for ram_init_file.
    ...
    // ram_init_file must be a literal string for Quartus; $readmemh still honors INIT_FILE.
    (* ram_init_file = "program.hex" *) logic [15:0] mem [0:127];
